...
Процедура ЗавершитьИзменениеОбъектов()
	...
	Элементы.НадписьРезультатыОбработки.Заголовок = СтрШаблон(
		ШаблонСообщения,
...
Функция ИзменяемыеРеквизиты(ИмяТабличнойЧасти = "РеквизитыОбъекта")
	...
	Возврат Спец_ОбщегоНазначения.ПреобразоватьМассивСтрокВТаблицуЗначений(ТаблицаРеквизитов.Выгрузить(Новый Структура("Изменять", Истина)));
КонецФункции
...
Процедура ИзменитьНаСервере(Знач ОстанавливатьИзменениеПриОшибке)
	...
	ПараметрыЗадания.Вставить("ДоступныеРеквизиты", Спец_ОбщегоНазначения.ПреобразоватьМассивСтрокВТаблицуЗначений(РеквизитыОбъекта.Выгрузить(, "Имя,Представление,ВидОперации,Свойство")));
