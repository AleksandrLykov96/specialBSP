...
Процедура ДобавитьНаФормуКнопкуОткрытияЛогов(Знач Форма, Знач ЭтоУправляемаяФорма = Неопределено) Экспорт
	...
	Если Не Спец_ЛогированиеОбъектовВызовСервераПовтИсп.ПринудительноДобавлятьКнопкуФормы()
		И Не Спец_ЛогированиеОбъектовКлиентСервер.ЛогиДоступныПоФорме(Форма, ЭтоУправляемаяФорма) Тогда
