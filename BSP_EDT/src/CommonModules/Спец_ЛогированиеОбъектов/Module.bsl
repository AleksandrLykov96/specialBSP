...
Функция ДобавляемКнопкуОткрытияЛогов(Знач Форма, Знач ЭтоУправляемаяФорма)
	...
	ПринудительноДобавляем = Спец_ЛогированиеОбъектовВызовСервераПовтИсп.ПринудительноДобавлятьКнопкуФормы();
	...
	Если ТипЛогирования = 2 Тогда
		Возврат Истина;
	ИначеЕсли ТипЛогирования = 0 И ПринудительноДобавляем Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
