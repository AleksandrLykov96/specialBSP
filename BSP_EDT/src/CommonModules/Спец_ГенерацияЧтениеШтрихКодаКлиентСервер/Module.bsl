...
Функция РазобратьСтрокуШтрихКодаGS1(Знач ШтрихКод)
	...
	КодыGS1 = Спец_ГенерацияЧтениеШтрихКодаКлиентСерверПовтИсп.КодыGS1();
...
// Параметры:
//  ШтрихКод - Строка
//  КодыGS1 - см. Спец_ГенерацияЧтениеШтрихКодаКлиентСерверПовтИсп.КодыGS1
...
Процедура РазобратьСтрокуШтрихКодаGS1СоСкобками(Знач ШтрихКод, Знач КодыGS1, РезультатРазбора)
	...
	РезультатРазбора.ШтрихКодBase64 = Спец_СтроковыеФункцииКлиентСервер.ПреобразоватьДвоичныеДанныеВСтрокуBase64(ПолучитьДвоичныеДанныеИзСтроки(ШтрихКодСРазделителями));
...
Процедура РазобратьСтрокуШтрихКодаGS1СРазделителями(Знач ШтрихКод, Знач КодыGS1, РезультатРазбора)
	...
	РезультатРазбора.ШтрихКодBase64 = Спец_СтроковыеФункцииКлиентСервер.ПреобразоватьДвоичныеДанныеВСтрокуBase64(ПолучитьДвоичныеДанныеИзСтроки(ШтрихКод));
