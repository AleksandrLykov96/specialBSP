...
Функция ИмяТаблицыВБДДляДругойБазы(Знач База, Знач ИмяМетаданных) Экспорт
	...
	Возврат Спец_ОбщегоНазначения.ПолучитьСтруктуруПервойВыборкиЗапроса(Запрос, "ИмяТаблицыВБД");
...
Функция КодТаблицыВБДДляДругойБазы(Знач База, Знач ИмяМетаданных) Экспорт
	...
	Возврат Спец_ОбщегоНазначения.ПолучитьСтруктуруПервойВыборкиЗапроса(Запрос, "КодТаблицыВБД");
...
Функция ГУИДПредопределенногоЗначенияДляДругойБазы(Знач База, Знач ИмяМетаданных, Знач ПеречислениеСсылка) Экспорт
	...
	Возврат Спец_ОбщегоНазначения.ПолучитьСтруктуруПервойВыборкиЗапроса(Запрос, "ГУИДПеречисленияВБазеДанных");
