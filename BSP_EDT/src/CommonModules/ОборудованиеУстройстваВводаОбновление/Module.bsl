...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = '1С:Сканеры штрихкода (Native Api)'", Метаданные.ОсновнойЯзык.КодЯзыка);
	Драйвер.ИдентификаторОбъекта = "InputDevice"; 
	Драйвер.ВерсияДрайвера = "10.3.1.2";
	Драйвер.ИмяМакетаДрайвера = "Драйвер1СУстройстваВводаNative";
	
//	Драйвер = ДрайвераОборудования.Добавить();
//	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.СканерШтрихкода;
//	Драйвер.ИмяДрайвера  = "ДрайверГексагонСканерыШтрихкода";
//	Драйвер.Наименование = НСтр("ru = 'Гексагон:Сканеры штрихкода Proton'", Метаданные.ОсновнойЯзык.КодЯзыка);
...
//	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Сканеры штрихкода 8.X'", Метаданные.ОсновнойЯзык.КодЯзыка);
...
//	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Считыватели магнитных карт 8.X'", Метаданные.ОсновнойЯзык.КодЯзыка);
//	Драйвер.ИдентификаторОбъекта = "ATOL_Scaners_1CInt"; 
//	Драйвер.ИмяМакетаДрайвера = "ДрайверАТОЛУстройстваВвода8X";
//	
//	Драйвер = ДрайвераОборудования.Добавить();
...
//	Драйвер.Наименование = НСтр("ru = '1С:Считыватели магнитных карт (Native Api)'", Метаданные.ОсновнойЯзык.КодЯзыка);
//	Драйвер.ИдентификаторОбъекта = "InputDevice"; 
...
//	Драйвер.Наименование = НСтр("ru = 'Iron Logic:Считыватели бесконтактных карт Z-2'", Метаданные.ОсновнойЯзык.КодЯзыка);
...
//	Драйвер.Наименование = НСтр("ru = 'Рус-Гард:Считыватель магнитных карт'", Метаданные.ОсновнойЯзык.КодЯзыка);
