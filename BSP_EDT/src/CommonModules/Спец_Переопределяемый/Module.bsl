...
// (для подчинённых регистров по регистратору, для остальных по ВСЕМ измерениям).
// 
// Параметры:
...
//
// Пример:
//  Если МетаданныеОбъекта = Метаданные.РегистрыСведений.Спец_ЗарегистрированныеОбъектыДляОбмена_Ссылки Тогда
...
//	КонецЦикла;
//
Процедура ЧисткаСтарыхЛишнихДанных(Знач Кэш) Экспорт
