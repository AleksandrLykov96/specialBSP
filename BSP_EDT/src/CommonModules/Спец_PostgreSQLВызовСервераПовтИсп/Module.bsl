...
Функция ПолучитьПредопределенныйЭлементПоГУИДуВБазе(Знач ГУИДЭлемента) Экспорт
	...
	Возврат Спец_ОбщегоНазначения.ПолучитьСтруктураПервойВыборкиЗапроса(Запрос, "ЭлементСсылка");
...
Функция ПолучитьНаименованиеТаблицыПоКоду(Знач КодТаблицы) Экспорт
	...
	Возврат Спец_ОбщегоНазначения.ПолучитьСтруктураПервойВыборкиЗапроса(Запрос, "НаименованиеВ1С");
