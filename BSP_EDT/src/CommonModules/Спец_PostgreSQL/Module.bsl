...
Функция ПодготовитьДанныеИзPostgreSQLПоТаблицам(Знач МассивИменТаблиц, Знач Кэш)
	...
	СтруктураРезультат = Спец_КомпонентаДополнительныеФункцииКлиентСервер.PostgreSQLВыполнитьЗапрос("SELECT * FROM vt_nametables", , , Кэш);
...
Процедура ОбновитьДанныеПоПредопределеннымВСтруктуреТаблицPostgreSQL(Знач ЭлементСправочникОбъект, Знач Кэш)
	...
	ИначеЕсли ЭлементСправочникОбъект.Столбцы.Найти("_predefinedid", "ИмяСтолбца") <> Неопределено Тогда
		...
		Попытка
			...
			МассивПредопределенных = СтруктураМетаданных.МетаданныеОбъекта.ПолучитьИменаПредопределенных();
			Если МассивПредопределенных.Количество() = 0 Тогда
				Возврат;
			КонецЕсли;
...
#Область Справочники
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_ВнешниеОбработки");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Родитель, ПометкаУдаления, ЭтоГруппа, Ссылка");
	СтруктураИндекса.Fillfactor = 99;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_ГруппыБазДляОбщихОбменов");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Наименование, Код, Ссылка");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	
	// Справочник.Спец_ГруппыБазДляОбщихОбменов.ОбщиеБазы
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_ГруппыБазДляОбщихОбменов.ОбщиеБазы");
	...
	// Справочник.Спец_РабочиеМеста
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_РабочиеМеста");

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("Ссылка");
	СтруктураОграничения.Fillfactor = 100;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("ИмяКомпьютера, Наименование, Ссылка");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураИндекса.Кластер    = Истина;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	// Справочник.Спец_ДрайверыОборудования
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_ДрайверыОборудования");

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("Ссылка");
	СтруктураОграничения.Fillfactor = 100;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("ТипОборудования, Наименование, Ссылка");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураИндекса.Кластер    = Истина;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	// Справочник.Спец_ПодключаемоеОборудование
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_ПодключаемоеОборудование");

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("Ссылка");
	СтруктураОграничения.Fillfactor = 100;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("РабочееМесто, Наименование, Ссылка");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураИндекса.Кластер    = Истина;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_Базы");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_Базы.HTTP");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("ЭтоЛокальныйАдрес");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураДляИндексацииТЧ.МассивИндексов.Добавить(СтруктураИндекса);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_МассивЗначенийКонстант");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Наименование, Код, Владелец, Ссылка");
	СтруктураИндекса.Fillfactor = 97;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	
	// Справочник.Спец_МассивЗначенийКонстант.ЗначенияКонстанты
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_МассивЗначенийКонстант.ЗначенияКонстанты");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_Пользователи");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных.Столбцы");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных.Индексы");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных.Ограничения");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных.Триггеры");
	...
	СтруктураДляИндексацииТЧ = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("Справочник.Спец_СтруктураТаблицБазыДанных.ПредопределенныеДанные");
...
#Область ПланыВидовХарактеристик
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("ПланВидовХарактеристик.Спец_Константы");

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("Ссылка");
	СтруктураОграничения.Fillfactor = 98;
	СтруктураОграничения.Кластер    = Истина;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Наименование, Ссылка");
	СтруктураИндекса.Fillfactor = 98;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Родитель, Код, ТипЗначения, Ссылка");
	СтруктураИндекса.Fillfactor = 98;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
...
#Область РегистрыСведений
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ЗарегистрированныеОбъектыДляОбмена_Регистры");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("UnixTimestamp, ПолноеИмяОбъектаМетаданных"); // Для быстрой работы на форме
	...
	|		NEW.[РегистрСведений.Спец_ЗарегистрированныеОбъектыДляОбмена_Регистры.UnixTimestamp] = extract(epoch from clock_timestamp());
	|		RETURN NEW;
	|	END;
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ЗарегистрированныеОбъектыДляОбмена_Ссылки");
	СтруктураДляИндексации.Fillfactor = 90;
	...
	|	BEGIN
	|		-- Заполняем UnixTimestamp
	|		NEW.[РегистрСведений.Спец_ЗарегистрированныеОбъектыДляОбмена_Ссылки.UnixTimestamp] = extract(epoch from clock_timestamp());
	|		RETURN NEW;
	|	END;
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ЛогиПоОбъектам");
	СтруктураДляИндексации.Fillfactor = 98;
	
	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("UnixTimestamp, Источник");
	СтруктураОграничения.Fillfactor = 94;
	СтруктураОграничения.Кластер    = Истина;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("Источник, UnixTimestamp"); // Для быстрой работы на форме
	СтруктураИндекса.Fillfactor = 94;
	СтруктураИндекса.Уникальный = Истина;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_НастройкиНочногоРасчета");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ОбъектыДляЛогирования");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ОбъектыДляРегистрацииДляОбменов");

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("База, ПолноеИмяОбъектаМетаданных");
	СтруктураОграничения.Fillfactor = 100;
	СтруктураОграничения.Кластер    = Истина;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ПараметрыОбменовСДругимиБазами");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_СоответствиеОбъектовДляОбмена");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_СтруктураТаблицБДИзДругихБаз");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ГУИДыОбъектовДругихБаз");
	...
	СтруктураИндекса = ПодготовитьСтруктуруИндексаДляУстановкиВPostgreSQL("База, МетаданныеПолноеИмя, ГУИД");
	СтруктураИндекса.Fillfactor = 100;
	СтруктураДляИндексации.МассивИндексов.Добавить(СтруктураИндекса);
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ПривязкаКлючевыхОбъектовКБазам");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_КэшДляФоновыхЗаданий");
	СтруктураДляИндексации.Fillfactor = 98;
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_РегистрОшибок");
	...
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_УведомленияДляПользователей");
	СтруктураДляИндексации.Fillfactor = 96;

	СтруктураОграничения = ПодготовитьСтруктуруОграниченияДляУстановкиВPostgreSQL("Период, ИмяПользователя");
	СтруктураОграничения.Fillfactor = 96;
	СтруктураДляИндексации.МассивОграничений.Добавить(СтруктураОграничения);

	МассивСтруктурДляОбновления.Добавить(СтруктураДляИндексации);
	
	// РегистрСведений.Спец_ХранимыеЗначенияКонстант
	СтруктураДляИндексации = ПодготовитьСтруктуруДляУстановкиВPostgreSQL("РегистрСведений.Спец_ХранимыеЗначенияКонстант");
...
Функция ОбработатьСтруктуруДляИндексации(Знач НаименованиеВPostgreSQL, Знач СтруктураДляОбновления, Знач Кэш)
	...
	СсылкаНаТаблицуДляОбновления = Спец_ОбщегоНазначения.ПолучитьСтруктураПервойВыборкиЗапроса(Запрос, "Ссылка"); // СправочникСсылка.Спец_СтруктураТаблицБазыДанных
...
#Область ПараметрыТаблицы
	...
	Если МассивТекстЗапроса.Количество() > 0 Тогда
		...
		ТекстОшибки  = "";
		ТекстЗапроса = СтрСоединить(МассивТекстЗапроса, Символы.ПС + ";" + Символы.ПС + Символы.ПС + Символы.ПС);
