...
//			** Значение - Строка
//
Функция HTTPClientПолучитьСтруктураЗапроса(Знач URL, Знач ИдентификаторЗапроса = "default", Знач ТипЗапроса = "POST", Знач ТелоЗапроса = "",
	...
	Если СоответствиеЗаголовков <> Неопределено Тогда
		Спец_РаботаСКоллекциямиКлиентСервер.ДополнитьОбъект(СоответствиеЗаголовков, СтруктураЗапроса.Заголовки);
	КонецЕсли;
...
// 
// Параметры:
//  СтруктураЗапроса - см. HTTPClientПолучитьСтруктураЗапроса
//
...
// 
// Параметры:
//  МассивИлиСтруктураЗапросов - Массив из см. HTTPClientПолучитьСтруктураЗапроса - Массив структур запросов или структура запроса для выполнения
//  						   - см. HTTPClientПолучитьСтруктураЗапроса
