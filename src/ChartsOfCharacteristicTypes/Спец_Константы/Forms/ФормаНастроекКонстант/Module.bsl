...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(КонстантаДляНастройки) Тогда
		КонстантаДляНастройкиПриИзменении(Элементы.КонстантаДляНастройки);
	КонецЕсли;
...
Процедура КомандаЗаписать(Команда)
	...
	СтруктураКлюча.Вставить("Константа", КонстантаДляНастройки);
	
	КлючЗаписиРегистра = Новый("РегистрСведенийКлючЗаписи.Спец_ХранимыеЗначенияКонстант", СтруктураКлюча);
	
	ОповеститьОбИзменении(КонстантаДляНастройки);
	ОповеститьОбИзменении(КлючЗаписиРегистра);
