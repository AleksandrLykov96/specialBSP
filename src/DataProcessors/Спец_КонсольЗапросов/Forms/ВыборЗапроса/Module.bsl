...
#Иначе
	...
	Если ТипЗнч(ФайлПервогоЗапроса) <> Неопределено
		...
		Спец_ОбщегоНазначенияКлиентСервер.УдалитьФайлыНеМешаяРаботе(ФайлПервогоЗапроса);
		Спец_ОбщегоНазначенияКлиентСервер.УдалитьФайлыНеМешаяРаботе(ФайлВторогоЗапроса);
	КонецЕсли;
#КонецЕсли
