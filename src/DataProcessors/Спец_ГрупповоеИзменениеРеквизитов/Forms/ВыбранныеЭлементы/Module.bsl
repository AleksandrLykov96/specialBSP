...
Процедура ОбновитьКоличествоВыбранныхСервер()
	...
	// ++ 28.08.2023 Лыков А.А.
	// {{
	//КоличествоВыбранных = ВыбранныеОбъекты().Строки.Количество();
	// }}
	КоличествоВыбранных = ВыбранныеОбъекты();
	// -- 28.08.2023 Лыков А.А.
	...
	Если ПредыдущееКоличествоВыбранных <> КоличествоВыбранных Тогда
		Элементы.ГруппаВыбранныеОбъекты.Заголовок = СтрШаблон(
...
Функция ВыбранныеОбъекты()
	// ++ 28.08.2023 Лыков А.А.
	//// Оооочень плохо работает для больших данных, переписываем.
	// {{
	...
	//Возврат Результат;
	// }}
	Возврат Спец_ОбщегоНазначения.ПолучитьКоличествоСтрокРезультатДинамическогоСписка(Элементы.Список);
	// -- 28.08.2023 Лыков А.А.
КонецФункции
