...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ВходныеДанные = Спец_СтроковыеФункцииКлиентСервер.СформироватьТекстовоеПредставлениеОбъекта(ТекущийОбъект.ВходныеДанные);
	ВыходныеДанные = Спец_СтроковыеФункцииКлиентСервер.СформироватьТекстовоеПредставлениеОбъекта(ТекущийОбъект.ВыходныеДанные);
