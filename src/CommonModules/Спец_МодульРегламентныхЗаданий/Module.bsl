...
Процедура ЧисткаСтарыхЛишнихДанных() Экспорт
	...
	ГраницаПоследнегоИзмененияОбычныхФайлов = ТекущаяДатаСеанса()
			- Спец_ПолучитьКонстанту(ПланыВидовХарактеристик.Спец_Константы.КоличествоЧасовДляЧисткиTMP, 36) * 3600;
