...
Функция ОбновитьПараметрыОбменовПоОбъекту_СформироватьТекстЗапросаДляОбменов(Знач ДляБазыОтправителя, Знач БазаПолучатель, Знач СтрокаПараметрДляОбработки, Кэш)
	...
	Для Каждого ИмяТабличнойЧасти Из МассивИменТабличныхЧастей Цикл
		...
		Если ДляБазыОтправителя Тогда
			МассивРеквизитов = Спец_РаботаСКоллекциямиКлиентСервер.ЗначениеВМассиве(Символы.Таб + """" + ИмяТабличнойЧастиПриемник + """ КАК Спец_ИмяТабличнойЧасти");
		Иначе
			МассивРеквизитов = Спец_РаботаСКоллекциямиКлиентСервер.ЗначениеВМассиве(Символы.Таб + """" + ИмяТабличнойЧасти + """ КАК Спец_ИмяТабличнойЧасти");
		КонецЕсли;
