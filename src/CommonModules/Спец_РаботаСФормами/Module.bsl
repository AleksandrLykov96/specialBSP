...
// Процедура для добавления нового отбора на красивую панель отборов
// 
// Параметры:
...
//
Процедура ДобавитьНовыйОтборНаПанель(Знач ПараметрыПанели, Знач ИмяПоля, Знач ВидСравнения, Знач Заголовок,
...
Функция НоваяСтруктураОтбораДляПанелиОтборов(Знач ИмяПоля, Знач ВидСравнения, Знач Заголовок, Знач ЧерезСтандартныйПериод, Знач ОписаниеТипаРеквизита)
	...
	Возврат Новый Структура("ИмяПоля, ВидСравнения, Заголовок, ЧерезСтандартныйПериод, ОписаниеТипаРеквизитаПоУмолчанию",
			ИмяПоля,
			ВидСравнения,
			Заголовок,
...
Функция НоваяСтруктураРеквизитаДляПанелиОтборов(Знач СтруктураОтбора, Знач ТипРеквизита)
	...
	Возврат Новый Структура("ИмяПоля, ВидСравнения, Заголовок, ЧерезСтандартныйПериод, ИмяРеквизита, ТипРеквизита",
			...
			"Спец_Отбор_" + Спец_СтроковыеФункцииКлиентСервер.ОчиститьИмяДляЗапроса(СтруктураОтбора.ИмяПоля),
			ТипРеквизита);
