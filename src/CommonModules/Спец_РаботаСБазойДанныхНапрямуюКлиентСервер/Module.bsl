...
//		* ПринудительноВозвращатьВсеЗаписи - Булево - Если ЛОЖЬ, то возвращает только изменённые записи.
//		                                              Если ИСТИНА, то после выполнения запроса присоединит готовую таблицу и вернёт все данные
//		                                              (используется только для НайтиНеОбновлятьСоздавать)
//
