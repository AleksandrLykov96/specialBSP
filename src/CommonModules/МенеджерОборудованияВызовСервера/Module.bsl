...
Функция ПодсистемаСуществует(ПолноеИмяПодсистемы) Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует(ПолноеИмяПодсистемы);
...
Функция ИспользуетсяУстройстваВвода() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.УстройстваВвода");
...
Функция ИспользуетсяШаблоныМагнитныхКарт() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.УстройстваВвода.ШаблоныМагнитныхКарт");
...
Функция ИспользуетсяЧекопечатающиеУстройства() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ЧекопечатающиеУстройства");
...
Функция ИспользуетсяКассоваяСмена() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ЧекопечатающиеУстройства.КассоваяСмена");
...
Функция ИспользуетсяФорматноЛогическийКонтроль() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ЧекопечатающиеУстройства.ФорматноЛогическийКонтроль");
...
Функция ИспользуетсяПлатежныеСистемы() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ПлатежныеСистемы");
...
Функция ИспользуетсяДисплеиПокупателя() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ДисплеиПокупателя");
...
Функция ИспользуетсяВесовоеОборудование() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ВесовоеОборудование");
...
Функция ИспользуетсяТерминалыСбораДанных() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ТерминалыСбораДанных");
...
Функция ИспользуетсяПринтерыЭтикеток() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.ПринтерыЭтикеток");
...
Функция ИспользуетсяСчитывательRFID() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПодключаемоеОборудование.СчитывательRFID");
...
Функция ИспользуетсяОфлайнОборудование() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ОфлайнОборудование");
...
Функция ИспользуетсяПечатьЭтикетокИЦенников() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ПечатьЭтикетокИЦенников");
...
Функция ИспользуетсяЭлектронныеСертификатыНСПК() Экспорт
	...
	Возврат Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ПоддержкаОборудования.ЭлектронныеСертификаты");
...
//	КонецЕсли;
	...
	Исключение
		МенеджерОборудования.ЗаписатьОшибкуВЖурналРегистрации(
			НСтр("ru = 'Ошибка системы взаимодействия'", Метаданные.ОсновнойЯзык.КодЯзыка));
		Возврат Неопределено;
	КонецПопытки;
...
Функция ПолучитьКартинкуШтрихкода(ПараметрыШтрихкода) Экспорт
	...
	РезультатОперации = Спец_ГенерацияЧтениеШтрихКодаКлиентСервер.ПолучитьИзображениеШтрихКода(ПараметрыШтрихкода);
...
Функция ЗаполненыДанныеАутентификацииПользователяИнтернетПоддержки() Экспорт
	...
	Если Спец_ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.БазоваяФункциональностьБИП") Тогда
		МодульИнтернетПоддержкаПользователей = Спец_ОбщегоНазначенияКлиентСервер.ОбщийМодуль("ИнтернетПоддержкаПользователей");
	...
	Если ЗначениеЗаполнено(РабочееМесто) Тогда
		...
		Для Каждого Оборудование Из СписокОборудования Цикл
			Если Оборудование.ПодключениеИзМакета И Оборудование.МакетДоступен И Оборудование.ТребуетсяПереустановка Тогда
				...
				МакетСтрока.Вставить("НаименованиеДрайвера", Оборудование.ДрайверОборудования.Наименование);
