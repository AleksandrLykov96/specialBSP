...
// Метод для переопределения параметров HTTP запроса для отправки в другую базу.
// По умолчанию: 
//	* УровеньБазы = Перечисления.УровеньБазы.ГлавныйУзел
//	* РаботаетВБазеРайона = Ложь
//
// Параметры:
//	УровеньБазы - ПеречислениеСсылка.УровеньБазы
//	РаботаетВБазеРайона - Булево
//
Процедура ПереопределитьПараметрыHTTPЗапроса(УровеньБазы, РаботаетВБазеРайона) Экспорт
