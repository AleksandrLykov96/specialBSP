...
Процедура ПриНачалеРаботыСистемы() Экспорт
	...
	Спец_ЗаписатьЛог("Начало сеанса", ПредопределенноеЗначение("Перечисление.Спец_УровниЛогирования.Информация"), "Начало сеанса");
...
Процедура ПриЗавершенииРаботыСистемы() Экспорт
	...
	Попытка
		Спец_ЗаписатьЛог("Завершение сеанса", ПредопределенноеЗначение("Перечисление.Спец_УровниЛогирования.Информация"), "Завершение сеанса");
	Исключение
	КонецПопытки;
...
Процедура ОбработкаОтображенияОшибки(Знач ИнформацияОбОшибке, Знач ТребуетсяЗавершениеСеанса, СтандартнаяОбработка) Экспорт
	...
	Попытка
		...
		Исключение
			...
			tmp = Спец_ОбщегоНазначенияКлиентСервер.КраткоеПредставлениеОшибкиЧерезОбработкуОшибок(ИнформацияОбОшибке);
