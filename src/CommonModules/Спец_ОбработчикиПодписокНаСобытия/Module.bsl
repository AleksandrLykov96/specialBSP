...
Функция ПропуститьВсеПроверкиПоОбъекту(Знач Источник, Знач СтруктураДополнительныхСвойств, Знач Кэш) Экспорт
	...
	Если ЭтоОбъектМетаданных Тогда
		СтруктураДополнительныхСвойств = НоваяСтруктураДополнительныхСвойств(Источник, Кэш);
	КонецЕсли;
	...
	ИначеЕсли Не ЭтоОбъектМетаданных И Спец_РаботаСКоллекциямиКлиентСервер.СвойствоСтруктуры(Источник.ДополнительныеСвойства, "Спец_ПропуститьПроверки", Ложь) = Истина Тогда
