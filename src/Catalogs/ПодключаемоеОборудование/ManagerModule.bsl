...
Функция СписокОборудования(Отбор) Экспорт
	...
	// Оборудование выбирается только по рабочему месту, если оборудование не сетевое
	Если СетевоеОборудование Тогда
		// Оборудование, подключенное к конкретному рабочему месту и сетевое оборудование.
		ТекстУсловия = "(ПодключаемоеОборудование.РабочееМесто = &РабочееМесто"
	...
	Иначе
		ТекстУсловия = ТекстУсловия + " И (НЕ ПодключаемоеОборудование.ПометкаУдаления И ПодключаемоеОборудование.УстройствоИспользуется)";
	...
	Иначе
		Если МассивТиповПО <> Неопределено Тогда
